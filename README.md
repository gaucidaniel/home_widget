...
### Jetpack Glance
In Jetpack Glance, you have to write you receiver (== provider), that returns a widget.
Add it to AndroidManifest the same way as written above for normal widgets.
...
If you need to access shared preferences, use this:

```kotlin
// Shared Preferences used by HomeWidget (this package)
HomeWidgetPlugin.getData(context)
